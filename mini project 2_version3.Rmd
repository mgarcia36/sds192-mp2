...
#### Our function: contribution_by_state
```{r, message=FALSE, include=FALSE, warning=FALSE}
...
# Using ggplot to generate bar plot of the "Committees that Received Contributions Made By Individuals in 2011 
# (California)" that is stored in the object: California plot
