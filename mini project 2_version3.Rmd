...
# slice(): selects top 10 committees at the top
...
florida_plot <- ggplot(contributions_by_florida, aes(cmte_name, com_groups)) +
  ggtitle("Committees that Received Contributions in 2011") +
  geom_bar(stat = "identity", fill = "olivedrab") +
  theme_hc() +
  theme(axis.text.x = element_text(color = "black", 
                           size = 9, family = "Trebuchet MS", angle = 90, hjust = 1, face = "bold"),
        axis.text.y = element_text(color = "black", 
                           size = 10, family = "Trebuchet MS", face = "bold"),
        axis.ticks.x = element_blank(),
        axis.ticks.y = element_blank(),
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
