...
ggplot(contributions_by_florida, aes(cmte_name, transaction_amt)) +
  ggtitle("Committees that Received Contributions Made By Individuals in 2011") +
...
The second data visualization presented is a bar plot regarding the contributions made in the state of California in the year 2011.The difference here, is that California is known for historically being a blue state during election cycles in comparison to Alaska. 
